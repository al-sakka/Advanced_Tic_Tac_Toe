    ...
    : QMainWindow(parent), ui(new Ui::GameScreen)
{
    ...
    for (int row = 0; row < 3; ++row) {
        for (int col = 0; col < 3; ++col) {
            ...
            connect(cellButtons[row][col], &CellButton::cellClicked, this, &GameScreen::handleCellClicked);
    ...
    connect(exitButton, &QPushButton::clicked, this, &GameScreen::handleExitButtonClicked);




    QObject::connect(ReturnMenu, &QPushButton::clicked, [=]() {
        MainScreen *mainScreen = new MainScreen(); // Create an instance of MainWindow
        mainScreen->show(); // Show the MainWindow
...
void GameScreen::setButtonStyle(QPushButton *button) {
...
void GameScreen::setButtonHoverEffect(QPushButton *button) {
...
void GameScreen::handleCellClicked(int player) {
...
void GameScreen::handleExitButtonClicked() {
