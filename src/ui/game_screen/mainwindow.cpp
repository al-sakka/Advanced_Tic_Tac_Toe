    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    // connect(ReturnMenu, &QPushButton::clicked, this, &MainWindow::handleReturnMenuClicked);
    /****************************************<Header Ui propr.>********************************************************************/
...
// void MainWindow::handleReturnMenuClicked() {
//     emit mainMenuButtonClicked(); // Emit signal indicating main menu button clicked
// }
