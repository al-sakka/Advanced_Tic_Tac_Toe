/****************************************************************************
** Meta object code from reading C++ file 'history_screen.h'
**
...
#include "../../../../src/ui/history_screen/history_screen.h"
...
#error "The header file 'history_screen.h' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject HistoryScreen::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHistoryScreenENDCLASS_t,
        ...
        // method 'handleReplayScreen'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<Database::GameHistoryEntry, std::false_type>
    >,
    nullptr
} };
...
void HistoryScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->handleReplayScreen((*reinterpret_cast< std::add_pointer_t<Database::GameHistoryEntry>>(_a[1]))); break;
        default: ;
        }
    }
}
