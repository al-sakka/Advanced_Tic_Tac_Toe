...
#include "../../../../src/ui/game_screen/CellButton.h"
...
void CellButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->cellClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->setCurrentPlayer((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        {
            using _t = void (CellButton::*)(int );
            if (_t _q_method = &CellButton::cellClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CellButton::cellClicked(int _t1)
{
